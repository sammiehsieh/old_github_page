...
| `/^([12]\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01]))$/` | 西元生日格式 | "1978-12-26" |
...
- Email，如`sammiehsieh@gmail.com`、`sammie0804@gms.tku.edu.tw`及`401730121@s01.tku.edu.tw`皆屬合法格式
- HTML格式，如網頁中所有的`<p></p>`
- 檔案名稱，如`.jpg`、`.gif`
...
| replace | 尋找字串中匹配的部，第二個參數為取代之新字串<br>匹配結果可利用 $1, $2, ..., $n 做搭配 |
...
var matchedResult1 = 'An apple a day keeps the doctor away.'.match(/ (a.) (p.) e/);
var matchedResult2 = 'An apple a day keeps the doctor away.'.match(/ (a.) (p.) e/g);

console.log(RegExp.$1); // "ap" 
console.log(RegExp.$2); // "pl"
console.log(matchedResult1); // ["apple", "ap", "pl"]
console.log(matchedResult2); // ["apple"]
```
...
- <a href="https://pjchender.github.io/2017/09/26/js-%E6%AD%A3%E5%89%87%E8%A1%A8%E9%81%94%E5%BC%8F-regular-expression-regex/" target="_blank">[JS] 正則表達式(Regular Expression, regex) | PJCHENder 私房菜</a>